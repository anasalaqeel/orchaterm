...
import { Edit2, Check, X as XIcon, Plus, Save, Workflow } from 'lucide-react';
...
interface PipelineBuilderProps {
  ...
  onSaveTemplate: (
    template: Omit<PipelineTemplate, 'id' | 'createdAt' | 'usedAt' | 'useCount'>
  ) => void;
                ...
                >
                  {isEditing ? (
                    ...
                    <>
                      ...
                      <span className={s.taskAgent} onDoubleClick={() => startEditing(task)}>
                        → {task.assignedSessionTitle}
                      </span>
                      <button
                        className={s.iconEditBtn}
        ...
        <div className={s.addRow}>
          ...
          <div className={s.agentSelect}>
            <Select
              ...
              options={[{ value: '', name: 'Select tab…', disabled: true }, ...sessionOpts]}
            />
          </div>
          <button
            className={s.addBtn}
            ...
            {showSave && (
              <div className={s.tplForm}>
                ...
                <div className={s.tplActions}>
                  ...
                  <button className={s.clearBtn} onClick={() => setShowSave(false)}>
                    Cancel
                  </button>
                </div>
              </div>

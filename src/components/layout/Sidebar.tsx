        ...
        <div className={s.body}>
          ...
          <div className={s.workspaceList} style={{ marginBottom: '12px' }}>
            {(() => {
              ...
              const isConsoleOpen =
                !!onDashboard && viewMode === 'console' && w.id === activeWorkspaceId;
              ...
              return (
                ...
                >
                  <div
                    className={cx(
                      s.wsRow,
                      isConsoleOpen && s.wsRowActive,
                      layoutCollapsed && s.wsRowCollapsed
                    )}
          ...
          <div className={s.workspaceList}>
            {workspaces.length === 0 && !collapsed && <p className={s.empty}>No workspaces yet.</p>}
                      ...
                      {isWsHovered && !collapsed && (
                        ...
                        >
                          <button
                            ...
                            onClick={() => {
                              if (window.confirm(`Delete "${w.name}"?`)) deleteWorkspace(w.id);
                            }}
                          >
                            <Trash2 size={10} />
                          </button>
          ...
          <nav className={s.nav}>
            <NavLink
              ...
              className={cx(
                s.navBtn,
                layoutCollapsed && s.navBtnCollapsed,
                isOverviewActive && s.navBtnActive
              )}
              onClick={() => {
                setViewMode('grid');
...
const s = {
  ...
  navPopoutActive: css`
    ...
    box-shadow:
      var(--shadow-lg),
      0 0 16px rgba(var(--color-brand-rgb), 0.3) !important;
    color: #fff !important;
  `,
};
